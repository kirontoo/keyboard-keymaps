...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_RAISE] = LAYOUT_ortho_hhkb(
        RESET,   RGB_TOG, RGB_MOD, _______, _______, _______, GAME,    BASE,    _______, _______, _______, _______,  _______, KC_MPLY,
    ...
    [_GAME] = LAYOUT_ortho_hhkb(
        ...
        KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_END,  KC_PGDN, KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,
                 KC_LCTL, KC_LGUI, KC_LALT, KC_LWR,           KC_SPC,  KC_BSPC,          KC_RAS, _______, _______, _______
    ),
};
