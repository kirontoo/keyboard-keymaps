...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BASE] = LAYOUT_ortho_hhkb(
        ...
        KC_LST,   KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_END,  KC_PGDN, KC_K,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RST,
                  KC_LCTL, KC_LGUI, KC_LALT, KC_LWR,           KC_SPC,  KC_BSPC,          KC_RAS,  GUI_TAP, ALT_TAP, CTRL_TAP
    ),

    [_LOWER] = LAYOUT_ortho_hhkb(
        KC_GRV,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_DEL,
        _______, KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC, _______, _______, KC_PLUS, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_UNDS,
        KC_CAPS, KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    _______, _______, KC_EQL,  KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_QUOT,
    ...
    [_RAISE] = LAYOUT_ortho_hhkb(
        RESET,   RGB_TOG, RGB_MOD, _______, _______, _______, GAME,    _______, _______, _______, _______, _______,  _______, KC_MPLY,
        ...
        KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_END,  KC_PGDN, KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,
                 KC_LCTL, KC_LGUI, KC_LALT, _______,          KC_SPC,  KC_BSPC,           _______, _______, _______, _______
    ),
};
